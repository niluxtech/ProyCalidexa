...
export default async function Home() {
  ...
  // Si empresas es un objeto paginado, usa la propiedad 'data'; si es array, úsalo directamente
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="flex-1 text-center lg:text-left animate__animated animate__fadeInLeft">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[var(--color-primary)] mb-4 leading-tight animate__animated animate__fadeInUp">
              ...
              <Link
                href="/contacto"
                className="inline-block text-white hover:text-[var(--color-secondary)] font-medium bg-[var(--color-primary)] hover:border-[var(--color-secondary)] px-8 py-3 rounded-full transition-colors text-base sm:text-lg animate__animated animate__fadeInUp animate__delay-2s"
              >
                Contáctanos
              </Link>
            </div>
          ...
          {empresasLogos.length > 0 && (
            <AnimateOnScroll animation="fadeInUp" delay="delay-2s">
              <div className="mt-12">
