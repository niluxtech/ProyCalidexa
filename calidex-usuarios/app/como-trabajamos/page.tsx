...
export const metadata = {
  ...
  description: "Conoce cómo CalidexA trabaja para generar confianza a través de transparencia, responsabilidad y compromiso con la calidad.",
};
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="bg-white py-16 lg:py-20">
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-16 max-w-6xl mx-auto">
            <AnimateOnScroll animation="fadeInLeft" threshold={0.2} className="flex-1 w-full">
            ...
            <AnimateOnScroll animation="fadeInRight" threshold={0.2} className="flex-1 w-full">
              <div>
                ...
                <p className="text-[var(--color-text-grey)] text-lg leading-relaxed mb-8">
                  En CalidexA nos tomamos muy en serio la confianza. Por eso hemos creado un sistema que evalúa, verifica y reconoce a las empresas que se comprometen con la calidad, la transparencia y el buen servicio, para que los clientes puedan elegir con más tranquilidad.
                </p>
                <Link
                  href="/contacto"
        ...
        <div className="container mx-auto px-4">
          <AnimateOnScroll animation="fadeInUp" threshold={0.2}>
            <div className="text-center mb-12">
              ...
              <p className="text-[var(--color-text-grey)] text-lg max-w-3xl mx-auto">
                CalidexA se sostiene sobre tres pilares que guían todas nuestras decisiones
              </p>
            </div>
          </AnimateOnScroll>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              {
                title: "Transparencia",
                description: "Promovemos información clara y honesta sobre las empresas que forman parte de la comunidad.",
                color: "bg-green-500",
                image: "/trasnparecnia.png",
              },
              {
                title: "Responsabilidad",
                description: "Las empresas acreditadas asumen compromisos frente a sus clientes y nuestra comunidad.",
                color: "bg-blue-500",
                image: "/responsabilidad.png",
              },
              {
                title: "Confianza",
                description: "Trabajamos para que cada experiencia de compra sea más segura y alineada a lo que se promete.",
                color: "bg-purple-500",
                image: "/confianza.png",
              },
            ].map((principio, index) => (
      ...
      <section className="bg-white py-16 lg:py-20">
        <div className="container mx-auto px-4">
          <AnimateOnScroll animation="fadeInUp" threshold={0.2}>
            <div className="text-center mb-12">
              <p className="text-[var(--color-secondary)] font-semibold mb-2">PASO A PASO</p>
            ...
            {[
              {
                ...
                description: "Validamos los datos esenciales de la empresa: existencia, rubro, contacto y representante responsable.",
              },
              {
                number: "2",
                numberColor: "border-blue-500",
                title: "Evaluación de buenas prácticas",
                description: "Revisamos que la empresa cumpla coherencia en su servicio, buena atención, tiempos razonables y trato adecuado.",
              },
              {
                number: "3",
                numberColor: "border-purple-500",
                title: "Acompañamiento y mejora continua",
                description: "Realizamos revisiones periódicas, analizamos experiencias de clientes y sugerimos mejoras cuando es necesario.",
              },
              {
                number: "4",
                numberColor: "border-[var(--color-secondary)]",
                title: "Reconocimiento CalidexA",
                description: "Destacamos a las empresas que mantienen buenas prácticas como negocios confiables y comprometidos con la calidad.",
              },
            ].map((paso, index) => (
              <AnimateOnScroll
                key={index}
                animation="fadeInUp"
                delay={`delay-${index * 0.2}s`}
                threshold={0.2}
              >
              ...
              <div>
                ...
                <ul className="space-y-4 text-[var(--color-text-grey)]">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Cumplir lo que prometen en sus canales de venta.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[var(--color-primary)] font-bold mt-1">•</span>
                    <span>Dar información clara sobre precios, condiciones y plazos.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[var(--color-primary)] font-bold mt-1">•</span>
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-[var(--color-primary)] font-bold mt-1">•</span>
                    <span>Permitir la verificación de información cuando sea requiera.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[var(--color-primary)] font-bold mt-1">•</span>
                    <span>Cuidar la reputación y confianza de la comunidad.</span>
                  </li>
                </ul>
              </div>
            </AnimateOnScroll>
            ...
            <AnimateOnScroll animation="fadeInRight" threshold={0.2} className="flex-1 w-full">
              <div>
                ...
                <ul className="space-y-4 text-[var(--color-text-grey)]">
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-[var(--color-primary)] font-bold mt-1">•</span>
                    <span>Monitoreamos cambios relevantes en la operación.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[var(--color-primary)] font-bold mt-1">•</span>
                    <span>Solicitamos aclaraciones o evidencia cuando hay dudas.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[var(--color-primary)] font-bold mt-1">•</span>
                    <span>Fomentamos el diálogo directo entre empresa y cliente.</span>
                  </li>
                </ul>
              </div>
            </AnimateOnScroll>
            ...
            {[
              {
                ...
                description: "Se informa el problema y se da opción a corregirlo.",
              },
              {
                number: "02",
                ...
                description: "Se monitorean nuevos casos y se pide información adicional.",
              },
              {
                number: "03",
                ...
                description: "La empresa deja de figurar como reconocida hasta mejorar sus prácticas.",
              },
              {
                number: "04",
                ...
                description: "Si persisten malas prácticas, se retira a la empresa de la comunidad.",
              },
            ].map((medida, index) => (
              <AnimateOnScroll
                key={index}
          ...
          <AnimateOnScroll animation="fadeInUp" threshold={0.2}>
            <div className="max-w-4xl mx-auto text-center text-white">
              ...
              <p className="text-lg mb-8 text-white/90 leading-relaxed">
                Al usar CalidexA tienes la garantía de que todas las empresas han sido previamente verificadas y evaluadas; además, puedes reportar cualquier inconveniente para que nuestro equipo lo revise, y cada empresa se compromete a cumplir estándares básicos de transparencia y buen servicio.
              </p>
